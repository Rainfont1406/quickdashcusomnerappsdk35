        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              errorStyle: const TextStyle(color: AppThemeData.primary500),
              filled: true,
              enabled: enable ?? true,
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: const BorderRadius.all(Radius.circular(10)),
                borderSide: BorderSide(color: isDarkMode(context) ? AppThemeData.primary500 : AppThemeData.primary500, width: 1),
              ),
