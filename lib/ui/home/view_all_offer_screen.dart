...
class _OffersScreenState extends State<OffersScreen> {
          ...
          Stack(
            ...
            children: [
              Image(
                ...
                fit: BoxFit.cover,
                height: (MediaQuery.of(context).size.width * 0.72).clamp(200.0, 320.0),
  ...
  openCouponCode(
    ...
    return Container(
      height: (MediaQuery.of(context).size.height * 0.35).clamp(220.0, 300.0),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text(
                                          ...
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, letterSpacing: 0.5, color: AppThemeData.primary500),
                                        )),
                                  ),
                                ),
                              ),
