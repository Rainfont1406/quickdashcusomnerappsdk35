...
//                               setState(() {});
//                             },
//                             activeBackgroundColor: AppThemeData.primary500,
//                             label: Text(
...
//                 child: Icon(
//                   Icons.circle,
//                   color: productModel.veg == true ? const Color(0XFF3dae7d) : AppThemeData.primary500,
//                   size: 13,
//                 ),
//               ),
//             )
...
//                                 style: TextStyle(fontSize: 18,  letterSpacing: 0.5, color: AppThemeData.primary500),
//                               )
//                             : Column(
//                                 crossAxisAlignment: CrossAxisAlignment.start,
//                                 children: [
...
//                                     style: TextStyle(  letterSpacing: 0.5, color: AppThemeData.primary500),
//                                   ),
//                                 ],
//                               ),
//                         TextButton.icon(
...
//                         //                       }
//                         //                     },
//                         //                     icon: Icon(Icons.add, size: 18, color: AppThemeData.primary500),
//                         //                     label: Text(
//                         //                       'ADD'.tr(),
//                         //                       style: TextStyle(height: 1.2, letterSpacing: 0.5, color: AppThemeData.primary500),
//                         //                     ),
//                         //                     style: TextButton.styleFrom(
...
//                                                   width: 5,
//                                                 ),
//                                                 Text("Closed".tr(), style: const TextStyle(  color: AppThemeData.primary500))
//                                               ])),
//                                         ),
//                                       )
//                                     ],
...
//               width: 10,
//             ),
//             Text("Close".tr(), style: const TextStyle(  fontSize: 16, letterSpacing: 0.5, color: AppThemeData.primary500))
//           ]));
//     }
//   }
//
