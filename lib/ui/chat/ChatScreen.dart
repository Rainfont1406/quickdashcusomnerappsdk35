...
//                                     child: Icon(
//                                       Icons.mic,
//                                       color: currentRecordingState == RecordingState.HIDDEN ? AppThemeData.primary500 : AppThemeData.primary500,
//                                     ),
//                                   ),
//                                   Expanded(
//                                     child: TextField(
...
//                         icon: Icon(
//                           Icons.send,
//                           color: _messageController.text.isEmpty ? AppThemeData.primary500.withOpacity(.5) : AppThemeData.primary500,
//                         ),
//                         onPressed: () async {
...
//                     child: PlayerWidget(
//                       url: messageData.url.url,
//                       color: isDarkMode(context) ? const Color(COLOR_ACCENT) : AppThemeData.primary500,
//                     ),
//                   ),
//                 ]),
//               ),
