...
class _GiftCardRedeemScreenState extends State<GiftCardRedeemScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Gift Redeem", style: TextStyle(color: AppThemeData.primary500, fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: false,
      ),
      body: Padding(
              ...
              children: [
                ...
                TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: BorderSide(color: AppThemeData.primary500, width: 2.0)),
