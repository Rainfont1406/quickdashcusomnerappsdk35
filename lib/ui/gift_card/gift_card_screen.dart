...
class _GiftCardScreenState extends State<GiftCardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Customize Gift Card", style: TextStyle(color: AppThemeData.primary500, fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: false,
        actions: [
          InkWell(
              onTap: () {
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            height: 60,
                                            decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(14)), border: Border.all(color: AppThemeData.primary500)),
                                            child: Padding(
                                      ...
                                      InkWell(
                                          ...
                                          child: Text("Add", style: TextStyle(color: AppThemeData.primary500))),
                                    ],
                                  )
                                : Container(
                                    height: 60,
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Container(
                                                    decoration: BoxDecoration(
                                                        ...
                                                        border: Border.all(color: selectedAmount == amount[index] ? AppThemeData.primary500 : Colors.grey)),
                                                    child: Padding(
                                                      padding: const EdgeInsets.symmetric(horizontal: 10),
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                    ...
                                                    border: Border.all(
                                                        color:
                                                            selectedAmount != "1000" && selectedAmount != "2000" && selectedAmount != "5000" ? AppThemeData.primary500 : Colors.grey)),
                                                child: Padding(
